-- Create documents table for public DocsSection with admin management (retry policies)
...
-- Policies
drop policy if exists "Public can view published docs" on public.documents;
create policy "Public can view published docs" on public.documents
for select to anon
using (published = true);

drop policy if exists "Authenticated can view all docs" on public.documents;
create policy "Authenticated can view all docs" on public.documents
